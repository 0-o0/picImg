<template>
  <svg t="1656846938380" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="3062">
    <path fill="var(--b2-theme-c)"
      d="M522.54 480.9m32 0l218.51 0q32 0 32 32l0 0q0 32-32 32l-218.51 0q-32 0-32-32l0 0q0-32 32-32Z" p-id="3063">
    </path>
    <path
      ...
      fill="var(--b2-theme-c)" p-id="3064"></path>
  </svg>
</template>
